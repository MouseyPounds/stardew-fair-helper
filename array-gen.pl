...
# array-gen.pl
#
# Utility script to create javascript arrays from raw ObjectInformation data
...
my @invalid = (0,2,4,75,76,77,79,102,290,294,295,313,314,315,316,317,318,319,320,321,326,343,449,450,452,461,
	...
	801,803,810,811,
	25,73,816,817,818,819,839,842,843,844,845,846,847,849,850,858,859,860,861,862,863,880,882,883,884,887,888,
	892,893,894,895,922,923,924,925,927,929,930
	);
my %invalid = ();
...
__DATA__
  ...
  "889": "Qi Fruit/1/1/Basic -79/Qi Fruit/Mr. Qi has challenged you to ship 1000 of these strange melons.",
  ...
  "926": "Cookout Kit/3000/-300/Crafting/Cookout Kit/Use this to create a cooking campfire, allowing you to cook on-the-go!",
  "927": "Camping Stove/3000/-300/Crafting/Camping Stove/This allows you to cook anywhere, and is not consumed on use.",
